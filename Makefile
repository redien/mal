...
IMPLS = ada awk bash batch c d clojure coffee cpp crystal cs erlang elisp \
...
test_EXCLUDES += test^batch^step5  # too slow for 10,000
...
batch_STEP_TO_PROG =   batch/$($(1)).bat
c_STEP_TO_PROG =       c/$($(1))
d_STEP_TO_PROG =       d/$($(1))
